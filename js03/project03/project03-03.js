...
// Declaring an html variable with a empty string
let htmlCode = "";

// Declaring a for loop that will loop through the titles array.
for (let i = 0; i < titles.length; i++) {
  htmlCode += "<tr>";

  // This line moves the description info one column to the right.
  // htmlCode += "<td><a href='" + links[i] + "'>" + titles[i] + "</a><td>";

  // This line keeps the description info under the description column.
  htmlCode += "<td>";
